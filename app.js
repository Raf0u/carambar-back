...
// CORS : Indispensable pour que le Front (sur un autre domaine) puisse appeler le Back.
app.use(cors());

// Parser JSON : Permet de lire le body des requêtes POST (transforme le texte brut en objet JS).
